...
import 'package:untitled8/reuseable/widgets.dart';
        ...
        children: [
          ...
          Container(
            ...
            child: Center(
              child: Text(
                status,
                style: const TextStyle(color: mycolor.whit,
                fontWeight: FontWeight.w600),
              ),
            ),
          )
            ...
            Row(
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                      color:model[i]['status'] == 'Available' ? mycolor.primary: mycolor.red,
                      borderRadius: BorderRadius.circular(25)
                  ),
                  child: Text(model[i]['status'],style: const TextStyle(color: mycolor.whit,fontWeight: FontWeight.w500,fontSize: 15),),
                ),
              ],
            ),
