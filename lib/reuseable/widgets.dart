...
import 'package:untitled8/res/theme/app_theme.dart';
  ...
  return Column(
    ...
    children: [
      Padding(
        ...
        child: Text(
          title,
          style: TextStyle(fontSize: 15, color: mycolor.fntClr, fontWeight: FontWeight.w500),
        ),
      ),
              ...
              // hintText: "Number of hours",
                border: OutlineInputBorder(
                    ...
                    borderSide: BorderSide(
                        color: mycolor.fntClr.withOpacity(0.5)))),
          ),
        ),
      ),
    ],
